...
@interface editorMyCommunityVC ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate>{
    ///省
...
@implementation editorMyCommunityVC
...
//                for (NSDictionary *proDic in arr) {
//                    NSString *str1 = [NSString stringWithFormat:@"%@",proDic[@"id"]];
//                    kLog(@"%@---%@", str1,self.commuDic[@"parentOne_id"]);
//                    if ([str1  isEqualToString:self.commuDic[@"parentOne_id"]]) {
//                         kLog(@"%@", proDic[@"areaName"]);
//                        self.labProvence.text = proDic[@"areaName"];
//                        NSMutableDictionary *params = [NSMutableDictionary new];
//                        [params setObject:proDic[@"id"] forKey:@"parentId"];
//                       [[HYHttp sharedHYHttp] POST:GetAddressLinkUrl parameters:params success:^(id  _Nonnull responseObject) {
...
//        
////        NSMutableDictionary *params = [NSMutableDictionary new];
////        [params setObject:self.commuDic[@"parentTow_id"] forKey:@"parentId"];
////        [[HYHttp sharedHYHttp] POST:GetAddressLinkUrl parameters:params success:^(id  _Nonnull responseObject) {
////            kLog(@"%@", responseObject);
////            NSDictionary *dic = responseObject[@"obj"];
////            NSArray *arr = dic[@"rows"];
////            self.labCity.text =arr[0][@"areaName"];
////            
////        } failure:^(NSError * _Nonnull error) {
////            kLog(@"%@", error);
////        }];
//        
//        
////        NSMutableDictionary *paramss = [NSMutableDictionary new];
////        [paramss setObject:self.commuDic[@"areaInfo_id"] forKey:@"parentId"];
////        [[HYHttp sharedHYHttp] POST:GetAddressLinkUrl parameters:paramss success:^(id  _Nonnull responseObject) {
////            kLog(@"%@", responseObject);
////            NSDictionary *dic = responseObject[@"obj"];
////            NSArray *arr = dic[@"rows"];
////            self.labArea.text =arr[0][@"areaName"];
////            
////        } failure:^(NSError * _Nonnull error) {
////            
////        }];
...
- (void)setAddRequest{
    if (![self isAvailableInfo]) {
        ...
        [param setObject:@"21" forKey:@"buildingInfoId"];
        if (_dataID) {
